    ...
    <div className="h-9 flex items-center bg-surface-rail/80 border-b border-border-default select-none relative">
      ...
      <div className="flex items-center pl-2 h-full shrink-0">
        <button
          ...
          className="flex items-center justify-center w-7 h-7 rounded-md hover:bg-zinc-700/40 transition-colors cursor-pointer"
          title="回到大堂"
        >
      ...
      <div className="flex items-center h-full">
        ...
        >
          <span className="w-6 h-6 flex items-center justify-center rounded-md
            hover:bg-zinc-700/40 transition-all duration-200">
            <svg
        ...
        >
          <span className="w-6 h-6 flex items-center justify-center rounded-md
            hover:bg-zinc-700/40 transition-all duration-150">
            <svg className="w-3 h-3 text-text-muted" fill="none" viewBox="0 0 24 24" stroke="currentColor">
              <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={1.5}
