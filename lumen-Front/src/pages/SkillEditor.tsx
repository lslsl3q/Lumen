      ...
      <div className="max-w-2xl mx-auto px-6 space-y-6">
        ...
        <section className="space-y-4">
          ...
          <div>
            ...
            <input
              ...
              className="w-full px-3 py-2 rounded-lg bg-slate-800/40 border border-slate-700/40 text-slate-200 focus:outline-hidden focus:border-[var(--color-primary)]/40 transition-all"
        ...
        <section className="space-y-4">
          ...
          <div>
            <input
              ...
              className="w-full px-3 py-2 rounded-lg bg-slate-800/40 border border-slate-700/40 text-slate-200 focus:outline-hidden focus:border-[var(--color-primary)]/40 transition-all font-mono text-sm"
        ...
        <section className="space-y-4">
          ...
          <div>
            <textarea
              ...
              rows={10}
              className="w-full px-3 py-2 rounded-lg bg-slate-800/40 border border-slate-700/40 text-slate-200 focus:outline-hidden focus:border-[var(--color-primary)]/40 transition-all font-mono text-sm resize-y"
        ...
        <div className="flex gap-3 pt-4">
          ...
          <button
            onClick={handleSave}
            disabled={isSaving}
            className="px-5 py-2.5 rounded-lg text-sm bg-[var(--color-primary)]/10 border border-[var(--color-primary)]/30 text-[var(--color-primary)] hover:bg-[var(--color-primary)]/20 disabled:opacity-40 transition-all"
          >
            {isSaving ? '保存中...' : '保存'}
          </button>
        </div>
