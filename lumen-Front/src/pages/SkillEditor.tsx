        ...
        <section className="space-y-4">
          ...
          <div>
            ...
            <input
              ...
              className="w-full px-3 py-2 rounded-lg bg-slate-800/40 border border-slate-700/40 text-slate-200 focus:outline-hidden focus:border-primary/40 transition-all"
        ...
        <section className="space-y-4">
          ...
          <div>
            <input
              ...
              className="w-full px-3 py-2 rounded-lg bg-slate-800/40 border border-slate-700/40 text-slate-200 focus:outline-hidden focus:border-primary/40 transition-all font-mono text-sm"
        ...
        <section className="space-y-4">
          ...
          <div>
            <textarea
              ...
              rows={10}
              className="w-full px-3 py-2 rounded-lg bg-slate-800/40 border border-slate-700/40 text-slate-200 focus:outline-hidden focus:border-primary/40 transition-all font-mono text-sm resize-y"
