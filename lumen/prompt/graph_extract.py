...
## 输出格式
严格输出 JSON，不要额外文字：
{"entities": [{"name": "实体名", "type": "Character", "aliases": ["别名1"], "extra": {"描述": "..."}}], "edges": [{"src_name": "实体A", "dst_name": "实体B", "label": "关系动词", "fact": "自然语言描述两个实体之间的关系", "valid_at": null, "invalid_at": null}]}

## 边的时间戳规则（DATETIME RULES）
- 持续为真的事实：valid_at 设为文章/对话的时间，invalid_at 设为 null
- 已结束的事实：设置 invalid_at
- 无法判断时间的：两个字段都设为 null
