...
│       ├── components/           # UI 组件（ChatPanel, ActivityBar, SidePanel, Popover, MarkdownContent, CommandPalette, MemoryWindow, GraphWindow, GraphEditor, RpgPanel, FloatingLayerHost, TdbFileTree, ResizablePanel, PermissionTree, panels/）+ editors/（TipTap扩展：GhostText, FocusMode, SlashCommand, SceneBeat, SceneBeatView。旧PM NodeView节点已删除）
